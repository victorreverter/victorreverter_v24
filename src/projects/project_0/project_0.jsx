...
const Project_0 = () => {
  ...
  const navigateToElement = () => {
    // Use navigate or push to navigate to the desired URL
    window.scrollTo({
  ...
  return (
    <div className='project-container'>
      <div className="syllabus-element">
        <Link to={"#stationateryII"} className='syllabus-elem'>AFA Zone </Link>
        <Link to="#stationateryII" onClick={navigateToElement}>
          Scroll to Element
        </Link>
      </div>
